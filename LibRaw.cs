...
namespace ASCOM.DSLR.Native
{
    ...
    public struct libraw_data_t
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2976)] char[] makernotes;
...
[StructLayout(LayoutKind.Sequential)]
    ...
    ushort ColorSpace;
      [MarshalAs(UnmanagedType.ByValArray, SizeConst = 128)] string firmware;
}
    ...
    public struct libraw_output_params_t
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)] string p4shot_order;
        /* Custom camera list */
...
;
    ...
    public struct libraw_hasselblad_makernotes_t
    {
        int BaseISO;
        double Gain;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] string Sensor;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 64)] string SensorUnit; // SU
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 64)] string HostBody;   // HB
        int SensorCode;
        int SensorSubCode;
        int CoatingCode;
        int uncropped;
        ...
        /* CaptureSequenceInitiator is based on the content of the 'model' tag
          ...
          - otherwise 'model' contains:
            ...
            3. HB;
        */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] string CaptureSequenceInitiator;

        /* SensorUnitConnector, makernotes 0x0015 tag:
         - in .3FR - SU side
         - in .FFF - HB side
        */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 64)] string SensorUnitConnector;
...
[StructLayout(LayoutKind.Sequential)]
    public struct libraw_fuji_info_t
    {
        ...
        ushort FrameWidth;
        ushort FrameHeight;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 0x0c + 1)] string SerialSignature;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4 +1 )] string RAFVersion;
    ...
    public struct libraw_olympus_makernotes_t
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)] string CameraType2;
    }
    ...
    struct libraw_samsung_makernotes_t
    {
        ...
        int DeviceType;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)] string LensFirmware;
    }
